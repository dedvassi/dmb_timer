...
const END_DATE_STR = '2025-08-01T16:00:00';
...
const PHRASES = [
	...
	'Наркоманы',
	'Встаньте еще на плацу и дрочить начните',
	'И женщине без трусов уже трудно сбить меня с истинного пути',
	'В чем отличие "ебать бабу" от "выебать бабу"? Первое это процесс, второе - результат',
	'Здравия желаю, товарищи гвардейцы',
	'Напоминаю про приказ три четверки: технику безопасности не нарушаем'
